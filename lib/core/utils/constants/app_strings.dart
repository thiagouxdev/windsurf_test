...
import 'package:basic_app/core/translations/app_translations.dart';

class AppStrings {
  // App Name
  static const String appName = 'Basic App';
  ...
  static String getMessages(BuildContext context) =>
      AppTranslations.translate(context, 'messages');

  static const String favorites = 'Favoritos';
  static String getFavorites(BuildContext context) =>
  ...
  static String getCounterText(BuildContext context) =>
      AppTranslations.translate(context, 'counterText');
  ...
  static String getMessagesEmpty(BuildContext context) =>
      AppTranslations.translate(context, 'messagesEmpty');

  // Favorites Page
  static const String favoritesEmpty = 'Página de Favoritos';
  static String getFavoritesEmpty(BuildContext context) =>
      AppTranslations.translate(context, 'favoritesEmpty');
  ...
  static String getSettingsProfile(BuildContext context) =>
      AppTranslations.translate(context, 'settingsProfile');

  static const String settingsMyData = 'Meus dados';
  static String getSettingsMyData(BuildContext context) =>
      AppTranslations.translate(context, 'settingsMyData');
